							...
							<fieldset className="border rounded-md my-6">
								...
								<div className="grid grid-cols-1 md:grid-cols-3 gap-4 pt-4 mb-4">
									...
									<ReusableSelectField
										...
										options={[
											{
												label: t("fields.plan_type.options.basic"),
												value: "basic",
											},
											{
												label: t("fields.plan_type.options.standard"),
												value: "standard",
											},
											{
												label: t("fields.plan_type.options.comprehensive"),
												value: "comprehensive",
											},
											{
												label: t("fields.plan_type.options.family"),
												value: "family",
											},
										]}
										onValueChange={(value) => {
