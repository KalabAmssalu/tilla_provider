...
import { reportColumns } from "@/components/screen/reports/ColumnsDefinition";
...
export default function CustomGrid({
	...
	dataSearched: ClaimdetailType[];
}) {
	const [data, setData] = useState<ClaimdetailType[]>([]); // Assuming the data will have the required fields
