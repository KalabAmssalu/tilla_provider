...
const ClaimMember = ({ userDetail }: { userDetail: memberType }) => {
	const sampleMember = {
		...
		first_name_amharic: "ከበደ",
		middle_name_amharic: "አበበ",
		last_name_amharic: "ታደሰ",
			...
			<>
				<Accordion type="single" defaultValue="item-1" collapsible>
					<AccordionItem value="item-1">
						<AccordionTrigger className="bg-secondary animate-pulse text-xl w-full rounded-md pl-4 pr-4 font-bold">
							{sampleMember.first_name}&apos;s Detail Information
						</AccordionTrigger>
						<AccordionContent>
